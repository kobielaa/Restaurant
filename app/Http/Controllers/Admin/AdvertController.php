...
class AdvertController extends Controller
{
    ...
    {
        $adverts = Advert::filter($request->all())
        ...
        return view('admin.adverts.adverts.list')->with($params);
    }
    ...
    public function create()
    {
        ...
        return view('admin.adverts.adverts.create')->with($params);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.adverts.adverts.index')->with('success', "Advert created");
    }
    ...
    public function show($id)
    {
        try
        {
            ...
            return view('admin.adverts.adverts.delete')->with($params);
        }
    ...
    public function edit($id)
    {
        try
        {
            ...
            return view('admin.adverts.adverts.edit')->with($params);
        }
        catch (ModelNotFoundException $ex) 
        {
            if ($ex instanceof ModelNotFoundException) {
    ...
    public function update(Request $request, $id)
    {
        try
        {
            ...
            $advert->user_id            = $request->input('user');
            ...
            return redirect()->route('admin.adverts.adverts.index')->with('success', 'Advert has been updated.');
        }
        catch (ModelNotFoundException $ex) 
        {
            if ($ex instanceof ModelNotFoundException) {
    ...
    public function destroy($id)
    {
        try
        {
            ...
            return redirect()->route('admin.adverts.adverts.index')->with(
                'success', 
                'Advert deleted'
            );
        }
