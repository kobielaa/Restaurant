<div class="col-lg-6 col-md-12">
    <div class="form-group">
        <div class="input-group @if ($errors->has('first_name')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="first_name" value="{{ $advert->first_name }}" id="first_name" required="">
    ...
    <div class="form-group">
        <div class="input-group @if ($errors->has('last_name')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="last_name" value="{{ $advert->last_name }}" id="last_name" required="">
            <span class="input-group-addon"><i class="fa fa-pencil"></i></span>
        </div>
    ...
    <div class="form-group">
        <div class="input-group @if ($errors->has('company')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="company" value="{{ $advert->company }}" id="company" required="">
    ...
    <div class="form-group">
        <div class="input-group @if ($errors->has('email')) is-invalid @endif">
            ...
            <input type="email" class="form-control" name="email" value="{{ $advert->email }}" id="email" required="">
    ...
    <div class="form-group @if ($errors->has('language')) is-invalid @endif">
        ...
        <select class="form-control" id="language" name="language">
            ...
            <option value="{{$row->id}}" @if($advert->language_id == $row->id) selected="true" @endif>{{$row->name}}</option>
            @endforeach
            @endif
        </select>
...
<div class="col-lg-6 col-md-12">
    <div class="form-group">
        <div class="input-group @if ($errors->has('phone')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="phone" value="{{ $advert->phone }}" id="phone">
    ...
    <div class="form-group">
        <div class="input-group @if ($errors->has('mobile')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="mobile" value="{{ $advert->mobile }}" id="mobile">
            <span class="input-group-addon"><i class="fa fa-phone"></i></span>
        </div>
    ...
    <div class="form-group">
        <div class="input-group @if ($errors->has('fax')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="fax" value="{{ $advert->fax }}" id="fax">
            <span class="input-group-addon"><i class="fa fa-phone"></i></span>
        </div>
        @if ($errors->has('fax'))
        <span class="invalid-feedback">
    ...
    <div class="form-group">
        <div class="input-group @if ($errors->has('website')) is-invalid @endif">
            ...
            <input type="url" class="form-control" name="website" value="{{ $advert->website }}" id="website" required="">
