<div class="col-lg-6 col-md-12">
  <div class="form-group @if ($errors->has('payment_period')) is-invalid @endif">
    ...
    <select class="form-control" id="payment_period" name="payment_period">
      ...
      <option value="{{$row->id}}" @if($row->id == $advert->payment_period_id) selected="true" @endif>{{$row->name}}</option>
      @endforeach
      @endif
    </select>
  ...
  <div class="form-group @if ($errors->has('cusine')) is-invalid @endif">
    ...
    <select class="form-control select2" id="cusine" name="cusine">
      ...
      <option value="{{$row->id}}" @if($row->id == $advert->cusine_id) selected="true" @endif>{{$row->name}}</option>
      @endforeach
      @endif
    </select>
  ...
  <div class="form-group advert-category @if ($errors->has('advert_category')) is-invalid @endif">
    ...
    <select class="form-control" id="advert_category" name="advert_category">
      ...
      <option value="{{$row->id}}" @if($row->id == $advert->advert_category_id) selected="true" @endif>{{$row->name}}</option>
      @endforeach
      @endif
    </select>
  ...
  <div class="form-group wifi @if ($errors->has('wifi')) is-invalid @endif">
    ...
    <select class="form-control" id="wifi" name="wifi">
      <option value="" selected="true">@lang('general.form.select')</option>    
      <option value="no" @if($advert->wifi == 'no') selected="true" @endif>@lang('general.no')</option>
      <option value="yes" @if($advert->wifi == 'yes') selected="true" @endif>@lang('general.yes')</option>
    </select>
    @if ($errors->has('wifi'))
    <span class="invalid-feedback">
  ...
  <div class="form-group smoking @if ($errors->has('smoking')) is-invalid @endif">
    ...
    <select class="form-control" id="smoking" name="smoking">
      <option value="" selected="true">@lang('general.form.select')</option>    
      <option value="no" @if($advert->smoking == 'no') selected="true" @endif>@lang('adverts.smoking.no')</option>
      <option value="yes" @if($advert->smoking == 'yes') selected="true" @endif>@lang('adverts.smoking.yes')</option>
      <option value="mix" @if($advert->smoking == 'mix') selected="true" @endif>@lang('adverts.smoking.mix')</option>
    </select>
  ...
  <div class="form-group discount">
    <div class="input-group @if ($errors->has('discount')) is-invalid @endif">
      ...
      <input type="text" class="form-control" name="discount" value="{{ $advert->discount }}" id="discount">
...
<div class="col-lg-6 col-md-12">
  <div class="form-group @if($errors->has('advert_text')) is-invalid @endif">
    ...
    <textarea class="form-control" id="advert_text" name="advert_text" rows="4">{{$advert->text}}</textarea>
  ...
  <div class="form-group advert-promo">
    ...
    <textarea class="form-control" id="advert_promo" name="advert_promo" rows="4">{{$advert->promotion}}</textarea>
  </div>
</div>