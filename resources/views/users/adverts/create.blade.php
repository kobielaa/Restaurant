...
<div class="advert-content">
    ...
    <form id="add-ad-form" class="advert-form" method="POST" action="{{route('user.adverts.store')}}" enctype="multipart/form-data">
    {{ csrf_field() }}
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="advert-details @if ($errors->any()) validated @endif">
            <div class="contact-info">    
                ...
                <div class="row">
                    @include('users.adverts.create.contact-info')
                </div>
            </div>
            <div class="address-info">    
                ...
                <div class="row">
                    @include('users.adverts.create.address-info')
                </div>
            </div>
            <div class="ad-info">    
                <div class="row">
                ...
                <div class="row">
                    @include('users.adverts.create.ad-info')
                </div>
            </div>
            <div class="img-info">    
                <div class="row">
                ...
                <div class="row">
                    @include('users.adverts.create.img-info')
                </div>
            </div>
