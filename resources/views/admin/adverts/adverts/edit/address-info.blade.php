    ...
    <div class="form-group{{ $errors->has('country') ? ' is-invalid' : '' }}">
        ...
        <select class="form-control countries-list select2" id="country" name="country">
            ...
            @foreach($countries as $row)
                <option value="{{$row->id}}" @if($advert->country_id == $row->id) selected="true" @endif>{{$row->name}}</option>
            @endforeach
            @endif
        </select>
    ...
    <div class="form-group{{ $errors->has('city') ? ' is-invalid' : '' }}">
        ...
        <select class="form-control cities-list select2" id="city" name="city">
            ...
            @foreach($cities as $row)
                <option value="{{$row->id}}" @if($advert->city_id == $row->id) selected="true" @endif>{{$row->name}}</option>
            @endforeach
            @endif
        </select>
        @if ($errors->has('city'))
...
<div class="col-lg-6 col-md-12">
    <div class="form-group">
        <div class="input-group @if ($errors->has('zip')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="zip" value="{{ $advert->zip }}" id="zip">
    ...
    <div class="form-group">
        <div class="input-group @if ($errors->has('street')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="street" value="{{ $advert->street }}" id="street">
    ...
    <div class="form-group">
        <div class="input-group @if ($errors->has('home_number')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="home_number" value="{{ $advert->home_no }}" id="home_number">
