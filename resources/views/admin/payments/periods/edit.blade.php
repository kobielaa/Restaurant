...
<div class="title-block">
    <h1 class="title">@lang('payments.periods.edit')</h1>
</div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="card card-block">
                <div class="title-block">
                    <h3 class="title"><a href="{{route('admin.payments.periods.index')}}" class="btn btn-info btn-xs"><i class="fa fa-chevron-left"></i>@lang('general.nav.back')</a></h3>
                </div>
                 <form role="form" method="post" action="{{ route('admin.payments.periods.update', ['id' => $translations['element_id']]) }}">
                    {{ csrf_field() }}
                    @if(count($locales))
