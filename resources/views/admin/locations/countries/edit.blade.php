...
<div class="title-block">
    <h1 class="title">@lang('locations.countries.edit')</h1>
</div>
        ...
        <div class="col-md-6">
            <div class="card card-block">
                <div class="title-block">
                 ...
                 <form role="form" method="post" action="{{route('admin.locations.countries.update', ['id' => $translations['element_id']])}}">
                    {{csrf_field()}}
                    <div class="form-group{{$errors->has('iso') ? ' has-error' : ''}}">
                        <label class="control-label" for="iso">@lang('locations.countries.iso')
                            <span class="required">*</span>
                        </label>
                        <input type="text" value="{{$translations['iso']}}" id="iso" name="iso" class="form-control underlined">
                        @if ($errors->has('iso'))
                    ...
                    <div class="form-group{{$errors->has('iso3') ? ' has-error' : ''}}">
                        ...
                        <input type="text" value="{{$translations['iso3']}}" id="iso3" name="iso3" class="form-control underlined">
                        @if ($errors->has('iso3'))
                    ...
                    <div class="form-group{{$errors->has('continent') ? ' has-error' : ''}}">
                        ...
                        <input type="text" value="{{$translations['continent']}}" id="continent" name="continent" class="form-control underlined">
