<div class="col-lg-6 col-md-12">
  ...
  <div class="form-group">
    <div class="input-group @if ($errors->has('fax')) is-invalid @endif">
      ...
      <input type="text" class="form-control" name="fax" value="{{$user->fax}}" id="fax">
      <span class="input-group-addon"><i class="fa fa-phone"></i></span>
    </div>
    @if ($errors->has('fax'))
    <span class="invalid-feedback">
  ...
  <div class="form-group">
    <div class="input-group @if ($errors->has('website')) is-invalid @endif">
      ...
      <input type="url" class="form-control" name="website" value="{{$user->website}}" id="website" required="">
...
<div class="col-lg-6 col-md-12">
  <div class="form-group">
    <div class="input-group company agent @if ($errors->has('company')) is-invalid @endif">
      ...
      <input type="text" class="form-control" name="company" value="{{$user->company}}" id="company" required="">
  ...
  <div class="form-group">
    <div class="input-group company @if ($errors->has('nip')) is-invalid @endif">
      ...
      <input type="text" class="form-control" name="nip" value="{{$user->nip}}" id="nip" required="">
  ...
  <div class="form-group company @if ($errors->has('specialization')) is-invalid @endif">
    ...
    <select class="form-control" id="specialization" name="specialization">
      ...
      <option value="{{$row->id}}" @if($row->id == $user->specialization_id) selected="true" @endif>{{$row->name}}</option>
      @endforeach
      @endif
    </select>
  ...
  <div class="form-group cusine @if ($errors->has('cusine')) is-invalid @endif">
    ...
    <select class="form-control select2" id="cusine" name="cusine">
      ...
      <option value="{{$row->id}}" @if($row->id == $user->cusine_id) selected="true" @endif>{{$row->name}}</option>
      @endforeach
      @endif
    </select>
