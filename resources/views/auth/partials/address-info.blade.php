<div class="col-lg-6 col-md-12">
    <div class="form-group{{ $errors->has('country') ? ' is-invalid' : '' }}">
        ...
        <select class="form-control countries-list select2" data-live-search="true" id="country" name="country">
            ...
            <option value="{{$row->id}}"@if($row->id == old('country')) selected="true"@endif>{{$row->name}}</option>
            @endforeach
            @endif
        </select>
    ...
    <div class="form-group{{ $errors->has('city') ? ' is-invalid' : '' }}">
        ...
        <select class="form-control cities-list select2" data-live-search="true" id="city" name="city">
            <option value="-1" disabled="true" selected="true">@lang('general.form.select')</option>
        </select>
        @if ($errors->has('city'))
    ...
    <div class="form-group">
        <div class="input-group @if ($errors->has('other_city')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="other_city" value="{{ old('other_city') }}" id="other_city">
...
<div class="col-lg-6 col-md-12">
    <div class="form-group">
        <div class="input-group @if ($errors->has('zip')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="zip" value="{{ old('zip') }}" id="zip">
    ...
    <div class="form-group">
        <div class="input-group @if ($errors->has('street')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="street" value="{{ old('street') }}" id="street">
    ...
    <div class="form-group">
        <div class="input-group @if ($errors->has('home_number')) is-invalid @endif">
            ...
            <input type="text" class="form-control" name="home_number" value="{{ old('home_number') }}" id="home_number">
